...
- **Lianna Lim**: Created inital BN model. Conducted chi-square independence testing and created visualizations for dataset exploration and Bayesian Network analysis. Wrote unimplemented code to cross check the EM algorithm for HMM and authored/edited the Problem Statement, Introduction, Cross-Model Comparison, Limitations & Future Work sections, and Conclusion.
- **Ved Panse**:
